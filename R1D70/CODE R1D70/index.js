...
//restartButton.onclick = "url('index.html')";
...
function displayGameOver(){
  if (gameState=='gameover'){
    ...
    setTimeout(displayRestartGame, 11000);
  }
}
...
//   //
//   //     let b1=bricks[0][c];
//       // if (b1.unbroken=='false'){
//       //   score += 10;
//       // }
//       // let b2=bricks[1][c]
//       // if (b2.unbroken=='false'){
//       //   score += 10;
//       // }
//       let b3=bricks[2][c]
...
function drawPaddle() {
  if (gameState=='level1'||gameState=='playL1'||gameState=='pauseL1'||gameState=='level4'||gameState=='playL4'||gameState=='pauseL4'||gameState=='gameover'){
    context.fillStyle ='#0aeb00';
}
    else if (gameState=='level2'||gameState=='playL2'||gameState=='pauseL2'||gameState=='gameover'){
      context.fillStyle ='yellow';
  }
  else if (gameState=='level3'||gameState=='playL3'||gameState=='pauseL3'||gameState=='gameover'){
    context.fillStyle ='#0aeb00';
}
...
function movePaddle() {
  if (rightArrow && paddle.x <= (canvas_width - paddle.width) - 20) {
    paddle.x += paddle.speed;
  } else if (leftArrow && paddle.x >= 20) {
    paddle.x -= paddle.speed;
  }
}
...
function draw(){
  ...
  if (gameState!=='ending'){
    ...
    if(life==3){
      drawGameStats('WARNING : 3 lives left', 40, 40);
    }
    if (life==2){
      drawGameStats(life+' lives', 40, 40);
    }
    if (life==1){
      drawGameStats('death is near', 40, 40);
    }
    if (life==0){
