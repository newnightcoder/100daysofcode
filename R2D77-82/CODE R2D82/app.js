...
function counterMessage() {
  if (itemsTotal === 0) {
    ...
    const itemsCounterMessage = 'you have <span class="counter">1</span> thing to do.';
    itemsCounter.innerHTML = itemsCounterMessage;
  } else {
    const itemsCounterMessage = `you have <span class="counter">${itemsTotal}</span> things to do !`;
    itemsCounter.innerHTML = itemsCounterMessage;
  }
}
