  ...
  navigator.geolocation.getCurrentPosition((position) => {
    ...
    fetch(url + lat + lon + units + key)
      ...
      .then((data) => {
        ...
        // <div class="weatherIcon"><i class="owf owf-${data.weather[0].id}"></i></div>
      ...
      .catch(() => {
        ...
        weatherWrapper.innerHTML = '<p><span class="oops">ooops!!!</span> <br>Looks like something went wrong!<br> Please try to refresh the page.</p>';
      });
  });
}
function weatherApp() {
