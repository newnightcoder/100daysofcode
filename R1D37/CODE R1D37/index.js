...
function ballCollisionsPaddle(){
  if(yBall+3 > yPaddle && xBall>xPaddle && xBall < xPaddle+paddle_width){
    yBallSpeed = -yBallSpeed;
  }
}
//RESET
function resetBall(){
   if(yBall+ballRadius > yPaddle+paddle_height+2*ballRadius){
     yBallSpeed = xBallSpeed = 0;
     //alert('you lost! haha!'); i can't because it's looped in function game()! too bad lol
   }
}
